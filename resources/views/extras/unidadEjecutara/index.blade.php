        ...
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Configuraciones - Unidad Ejecutora</strong>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Todos las Unidades Ejecutoras</h5>
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody id="datos">
                            @foreach($ejecutara  as $item)
                                <tr>
                                    <td>{{$item->nombreUnidad}}</td>
                                    @can('unidadEjecutara.edit')
                                    <td>
                                    <a href="{{route('unidadEjecutar.edit',$item->id)}}" class="">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" method="post" id="crearUnidadEjecuta" name="crearUnidadEjecuta">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" class="form-control form-control-user"  id="nombreUnidad" name="nombreUnidad"  placeholder="NOMBRE...">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success" onclick="crearUnidadEjecutar()"> <i class="fa fa-check"></i> Guardar</button>
