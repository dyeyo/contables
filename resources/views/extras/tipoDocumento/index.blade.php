        ...
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Configuraciones - Tipo de Documentos</strong>
                </li>
            </ol>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($tipoDoc as $item)
                                <tr>
                                    ...
                                    @can('tipoDocumento.edit')
                                    <td>
                                        <a href="{{route('tipoDocumento.edit',$item->id)}}" class=""><i
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">AGREGAR TIPO DE IDENTIDAD</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('tipoDocumento.store')}}" method="post" id="newDoc" name="newDoc">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-user"  id="nombreDocumento" name="nombreDocumento"  placeholder="NOMBRE...">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success" onclick="crearTipoDoc()"> <i class="fa fa-check"></i> Guardar</button>
...
$(document).ready(function () {
    $('#newDoc').validate({ // initialize the plugin
