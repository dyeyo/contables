        ...
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Duplicar Transaccion {{$trasacciones->numero_doc}}</strong>
                </li>
            </ol>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes31" value="05" id="mayo">MAYO</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes30" value="06" id="junio">JUNIO</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes31" value="07" id="julio">JULIO</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes31" value="08" id="agosto">AGOS</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes30" value="09" id="septiembre">SEPTI</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm btn-block mes31" value="10" id="octubre">OCTUB</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm mes30" value="11" id="noviembre">NOVIE</button>
                                </div>
                                <div class="col-sm-4 col-md-1">
                                    <button class="btn btn-primary btn-sm mes31" value="12" id="diciembre">DICIEM</button>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text"  id="numero_doc" class="form-control form-control-user" name="numero_doc"  value="{{ old('numero_doc'). $trasacciones->numero_doc +999}}">
                            ...
                            <div class="row"  id="numeroDocumentos" readonly="readonly" >
                                <div class="col-md-12" style="overflow:scroll; height: 330px;">
                                    <table id="TablaPro" class="table">
                                        ...
                                        <td><input readonly="readonly" type="text" style="text-align:right;width:150px;" class="form-control form-control-user" name="total_debito" id="total_debito" data-id="{{$trasacciones->total_debito}}" value="{{$trasacciones->total_debito}}"></td>
                                        <td><input readonly="readonly" type="text" style="text-align:right;width:150px;" class="form-control form-control-user" name="total_credito" id="total_credito" data-id="{{$trasacciones->total_credito}}" value="{{$trasacciones->total_credito}}"></td>
                                        <td><input readonly="readonly" type="text" style="text-align:right;width:150px;" class="form-control form-control-user" name="diferencia" id="direfencia" value="{{$trasacciones->diferencia}}"></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        </tfoot>
                                ...
                                <div class="" style="overflow:scroll;
                                    ...
                                    <table id="TablaPro" class="table">
                                        ...
                                        @foreach($plantillaRetenciones as $item)
                                            ...
                                            --}}{{--<td>
                                                <form method="POST" id="deleteTipoDoc" action="{{route('transaccion.estadoPlantilla',$item->id)}}">
                                                    {{method_field('DELETE')}}
                                                    {{csrf_field()}}
                    ...
                    <table class="table tablaRetencion" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($retenciones as $item)
                            <tr>
                                ...
                                <td><input  style="width: 143px;" readonly="readonly" type="text" class="valorRetenido valorR" name="valorRetenido"  id="valorRetenido"></td>
                                <input type="hidden"  name="iva" id="iva" value="{{$item->iva}}"/></td>
                                <input type="hidden" class="retecionesDescuentos_id"  style="text-align:right" value="{{$item->id}}"/>
                ...
                if (montoMinimo !='' && porcentajeRetencion != ''){
                    if (base >= montoMinimo){
                        ...
                        $('#ProSelected').append('<tr class="active">'+
                            ...
                            '<td><span></span> </td>'+
                            '<td>' +
                            '<select style="width: 28pc;" onchange="niif()" name="puc_id[]" id="puc_id" class="select2Plan selef puc_id" >'+
                            '    @foreach($puc as $item)'+
                            '<option value="{{$item->id}}" {{ old('$puc') == $item->id ? 'selected' : '' }} >{{$item->codigo_cuenta}}-{{$item->nombre_cuenta}}</option>'+
                            '    @endforeach'+
                            '</select></td>' +
                            '</td>'+
                            '<td> ' +
                ...
                if (base_inical !='' && base_final !='' && porcentajeRetencion != ''){
                    if (base >= base_inical && base <= base_final){
                        ...
                        $('#ProSelected').append('<tr class="active">'+
                            ...
                            '<td><span></span> </td>'+
                            '<td>' +
                            '<select style="width: 28pc;" onchange="niif()" name="puc_id[]" id="puc_id" class="puc_idRetencion selef puc_id">'+
                            '</select></td>' +
                            '</td>'+
                            '<td>' +
                            '<select style="width: 28pc;" onchange="niif()" name="puc_id[]" id="puc_id" class="select2Plan selef puc_id" >'+
